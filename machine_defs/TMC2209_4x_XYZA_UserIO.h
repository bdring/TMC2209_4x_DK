...
/*
    ...
    2020-08-28 B. Dring for Leo Leo McElroy
...
#define MACHINE_NAME            "TMC2209 4x XYZA User IO"
...
#define USER_DIGITAL_PIN_0     GPIO_NUM_12 //  M62 P0 & M63 P0
#define USER_DIGITAL_PIN_1     GPIO_NUM_17
#define USER_ANALOG_PIN_0      GPIO_NUM_13 //  M67 E0 Q23.87 (set set output#1 to 23.87% duty)
